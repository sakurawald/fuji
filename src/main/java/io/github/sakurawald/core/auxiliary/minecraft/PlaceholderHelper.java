...
public class PlaceholderHelper {
    ...
    public static void serverPlaceholder(String name, BiFunction<MinecraftServer, String, Text> function) {
    ...
    public static void playerPlaceholder(String name, BiFunction<ServerPlayerEntity, String, Text> function) {
        PlaceholderHandler placeholderHandler = (ctx, arg) -> {
    ...
    public static void serverPlaceholder(String name, Function<MinecraftServer, Text> function) {
        serverPlaceholder(name, (server, args) -> function.apply(server));
    }

    public static void playerPlaceholder(String name, Function<ServerPlayerEntity, Text> function) {
