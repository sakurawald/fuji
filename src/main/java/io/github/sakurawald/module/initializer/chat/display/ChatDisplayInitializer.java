        ...
        Placeholders.register(
            ...
            (ctx, arg) -> {
                ...
                Component replacement =
                    MessageHelper.getTextByKey(player, "display.ender_chest.text")
                        .asComponent()
                        .hoverEvent(MessageHelper.getTextByKey(player, "display.click.prompt").asComponent())
    ...
    private void registerInvPlaceholder() {
        Placeholders.register(
            ...
            (ctx, arg) -> {
                ...
                Component replacement =
                    MessageHelper.getTextByKey(player, "display.inventory.text")
                        .asComponent()
                        .hoverEvent(MessageHelper.getTextByKey(player, "display.click.prompt").asComponent())
                        .clickEvent(buildDisplayClickEvent(displayUUID));
    ...
    public void registerItemPlaceholder() {
        Placeholders.register(
            ...
            (ctx, arg) -> {
                ...
                Component component =
                    MessageHelper.getTextByKey(player, "display.item.text")
                        .asComponent()
