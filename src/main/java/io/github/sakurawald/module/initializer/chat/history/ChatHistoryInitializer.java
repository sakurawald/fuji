...
public class ChatHistoryInitializer extends ModuleInitializer {
    ...
    public final ObjectConfigurationHandler<ChatHistoryConfigModel> config = new ObjectConfigurationHandler<>(getModuleConfigFileName(), ChatHistoryConfigModel.class);
