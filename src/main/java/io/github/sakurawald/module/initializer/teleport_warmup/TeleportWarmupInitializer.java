...
public class TeleportWarmupInitializer extends ModuleInitializer {
    public final ObjectConfigurationHandler<TeleportWarmupConfigModel> config = new ObjectConfigurationHandler<>(ReflectionUtil.getModuleConfigFileName(this), TeleportWarmupConfigModel.class);
