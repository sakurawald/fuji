...
public class TeleportWarmupInitializer extends ModuleInitializer {
    public final ObjectConfigurationHandler<TeleportWarmupConfigModel> config = new ObjectConfigurationHandler<TeleportWarmupConfigModel>(getModuleConfigFileName(), TeleportWarmupConfigModel.class);
