        ...
        for (String playerName : module.player2fakePlayers.keySet()) {
            ...
            if (expiration <= currentTimeMS) {
                ...
                for (String fakePlayerName : fakePlayers) {
                    ...
                    fakePlayer.kill();
                    MessageHelper.sendBroadcastByKey("fake_player_manager.kick_for_expiration", fakePlayer.getGameProfile().getName(), playerName);
                }
                // remove entry
            ...
            for (int i = fakePlayers.size() - 1; i >= limit; i--) {
                ...
                MessageHelper.sendBroadcastByKey("fake_player_manager.kick_for_amount", fakePlayer.getGameProfile().getName(), playerName);
            }
        }
    }
}
