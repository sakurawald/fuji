...
public class MultiObsidianPlatformInitializer extends ModuleInitializer {
    ...
    public final BaseConfigurationHandler<MultiObsidianPlatformConfigModel> config = new ObjectConfigurationHandler<>(ReflectionUtil.getModuleControlFileName(this), MultiObsidianPlatformConfigModel.class);
