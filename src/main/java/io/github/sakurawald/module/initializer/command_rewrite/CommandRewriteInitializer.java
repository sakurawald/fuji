...
public class CommandRewriteInitializer extends ModuleInitializer {
    public final BaseConfigurationHandler<CommandRewriteConfigModel> config = new ObjectConfigurationHandler<>(ReflectionUtil.getModuleControlFileName(this), CommandRewriteConfigModel.class);
}
