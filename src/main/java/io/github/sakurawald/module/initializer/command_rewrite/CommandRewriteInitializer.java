...
public class CommandRewriteInitializer extends ModuleInitializer {
    public final ObjectConfigurationHandler<CommandRewriteConfigModel> config = new ObjectConfigurationHandler<>(getModuleConfigFileName(), CommandRewriteConfigModel.class);
}
