...
public class CommandWarmupInitializer extends ModuleInitializer {
    public final ObjectConfigurationHandler<CommandWarmupConfigModel> config = new ObjectConfigurationHandler<>(getModuleConfigFileName(), CommandWarmupConfigModel.class);
}
