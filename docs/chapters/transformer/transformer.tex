...
\begin{enumerate}
    ...
    \item /blockinfo = use the command \ic{/info block} provided by \ttt{carpet} mod.
...
\begin{tips}{Use bundle command module to create transformed commands}
    See~\nameref{chap:command_bundle}
\end{tips}
