...
You can \ttt{disable} the \ttt{conflicting module}.If possible, create an issue in github, so that we can solve this later.


\section{How can I report bugs or suggest new features?}
You can create an issue at the project's \ttt{github issue page}.
