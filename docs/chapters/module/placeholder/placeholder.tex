...
\begin{description}
    ...
    \item[\ph{fuji:rorate hello}] rotate the string \tbf{hello}
    ...
    \item[\ph{fuji:escape}] escape a placeholder form the parser.\\An optional numebr argument is used as the levels to escape.
    \item[\ph{fuji:date}] get current date.\\An optional string argument is used to set the \tbf{date formatter}, for example, \ph{fuji:date HH:MM}.\\See also: \url{https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html}
\end{description}
