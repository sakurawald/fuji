...
\begin{description}
    ...
    An optional string argument is used to set the \tbf{date formatter}, for example, \ph{fuji:date HH:MM}.\\See also: \url{https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html}}
\end{description}
