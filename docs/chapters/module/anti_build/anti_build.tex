...
\begin{tips}{Query identifiers}
    To query block identifier, use \ic{/setblock ~ ~ ~ \ldots} command.\\
    To query entity identifier, use \ic{/summon \ldots} command.\\
    To query item identifier, use \ic{/give \ldots} command.
\end{tips}
